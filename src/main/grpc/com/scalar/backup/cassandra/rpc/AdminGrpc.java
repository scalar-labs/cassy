...
public final class AdminGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.scalar.backup.cassandra.rpc.PauseRequest,
      com.google.protobuf.Empty> getPauseMethod;

  public static io.grpc.MethodDescriptor<com.scalar.backup.cassandra.rpc.PauseRequest,
      com.google.protobuf.Empty> getPauseMethod() {
    io.grpc.MethodDescriptor<com.scalar.backup.cassandra.rpc.PauseRequest, com.google.protobuf.Empty> getPauseMethod;
    if ((getPauseMethod = AdminGrpc.getPauseMethod) == null) {
      synchronized (AdminGrpc.class) {
        if ((getPauseMethod = AdminGrpc.getPauseMethod) == null) {
          AdminGrpc.getPauseMethod = getPauseMethod = 
              io.grpc.MethodDescriptor.<com.scalar.backup.cassandra.rpc.PauseRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "rpc.Admin", "Pause"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.scalar.backup.cassandra.rpc.PauseRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.scalar.backup.cassandra.rpc.StatsResponse> getStatsMethod;

  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.scalar.backup.cassandra.rpc.StatsResponse> getStatsMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.scalar.backup.cassandra.rpc.StatsResponse> getStatsMethod;
    if ((getStatsMethod = AdminGrpc.getStatsMethod) == null) {
      synchronized (AdminGrpc.class) {
        if ((getStatsMethod = AdminGrpc.getStatsMethod) == null) {
          AdminGrpc.getStatsMethod = getStatsMethod = 
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, com.scalar.backup.cassandra.rpc.StatsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "rpc.Admin", "Stats"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.scalar.backup.cassandra.rpc.StatsResponse.getDefaultInstance()))
  ...
  public static abstract class AdminImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void pause(com.scalar.backup.cassandra.rpc.PauseRequest request,
    ...
    public void stats(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<com.scalar.backup.cassandra.rpc.StatsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.scalar.backup.cassandra.rpc.PauseRequest,
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.google.protobuf.Empty,
                com.scalar.backup.cassandra.rpc.StatsResponse>(
                  this, METHODID_STATS)))
          .build();
    }
  }
  ...
  public static final class AdminBlockingStub extends io.grpc.stub.AbstractStub<AdminBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty pause(com.scalar.backup.cassandra.rpc.PauseRequest request) {
    ...
    /**
     */
    public com.scalar.backup.cassandra.rpc.StatsResponse stats(com.google.protobuf.Empty request) {
      return blockingUnaryCall(
  ...
  public static final class AdminFutureStub extends io.grpc.stub.AbstractStub<AdminFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> pause(
        com.scalar.backup.cassandra.rpc.PauseRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.scalar.backup.cassandra.rpc.StatsResponse> stats(
        com.google.protobuf.Empty request) {
      return futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PAUSE:
          serviceImpl.pause((com.scalar.backup.cassandra.rpc.PauseRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
